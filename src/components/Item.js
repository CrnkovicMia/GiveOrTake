            ...
            <div className="itemInfoDiv">
                ...
                <div className="itemInfo">
                    <div className="infoLeft">
                        <span className="spanTitle"><strong>Nike Air Jordan</strong></span>
                        ...
                        <span className="textChange">Darujem nike air tenisce, nošene svega par puta.Darujem nike air tenisce, nošene svega par puta.Darujem nike air tenisce, nošene svega par puta.</span>
                    </div>
