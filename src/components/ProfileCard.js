...
export const ProfilCard = () =>{
    ...
    return(
        <div class="card-wrapperTwo">
                    <div class="cardTwo">
                    <div class="circleDivTwo" onClick={()=>{handleClick()}}>
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                className={active ? "absoluteSVGImageGreenTwo" : "absoluteSVGImageTwo"}
                                viewBox="0 0 24 24">
                        ...
                        <div class="cardImageDivTwo">
                            <img src={require('../images/portret.png')} alt="cardImag" class="cardImageTwo"/>
                        </div>
                        <div class="cardDescriptionTwo">
