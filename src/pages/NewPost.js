      ...
      <div className='newPostImages'>
        <div className='newPostLeft'>
          <div className='mainImage imgOne'>
            {file1 ? (
              <img className='mainImageInside' src={file1} onClick={handleClick}/>
            )
              : (
                <button className='mainImageInside' onClick={handleClick}>Dodaj<br />glavnu<br />fotografiju</button>
              )}
          ...
          <div className='mainImage imgOne'><div className='imageInside'>
            ...
            {file2 ? (
                <img className='imageInside' src={file2} onClick={handleClick2}/>
              )
              : (
                <button className='imageInside' onClick={handleClick2}>
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg"
                      className='plusIcon'
                      viewBox="0 0 256 256">
        ...
        <div className='newPostRight'>
          <div className='mainImage imgTwo'><div className='imageInside'>
            {file3 ? (
                  <img className='imageInside' src={file3} onClick={handleClick3}/>
                )
                : (
                  <button className='imageInside' onClick={handleClick3}>
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg"
                        className='plusIcon'
                        viewBox="0 0 256 256">
          ...
          <div className='mainImage imgTwo'><div className='imageInside'>
            {file4 ? (
                    <img className='imageInside' src={file4} onClick={handleClick4}/>
                  )
                  : (
                    <button className='imageInside' onClick={handleClick4}>
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg"
                          className='plusIcon'
                          viewBox="0 0 256 256">
